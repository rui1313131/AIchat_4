...
;var T,M;!function(e){e[e.VISIBLE=0]=VISIBLE,e[e.INVISIBLE=1]=INVISIBLE,e[e.OVERFLOW=2]=OVERFLOW}(T||(T={})),function(e){e[e.NORMAL=0]=NORMAL,e[e.ADD=1]=ADD,e[e.MULTIPLY=2]=MULTIPLY`}(M||(M={}));class v{constructor(e,t){this.id=e,this.opacity=t,this._isVisible=!0}get isVisible(){return this._isVisible}set isVisible(e){this._isVisible=e}}class _ extends v{constructor(e,t,i,n,o,r){super(e,i),this.name=n,this.parent=t,this.indices=o,this.vertices=r,this.culling=!1,this.blendMode=M.NORMAL}update(e){this.indices=this.indices,this.vertices=this.vertices,this.opacity=this.opacity}}class y{constructor(e){if(this.motions=e.motions,this.expressions=e.expressions,this.name=e.name,this.tag="InternalModel("+this.name+")",this.width=e.width,this.height=e.height,this.coreModel=e.coreModel,this.motionManager=e.motionManager,this.focusController=e.focusController,this.hitTester=e.hitTester,this.textures=e.textures,this.masks=new S(this),this.drawables=[],e.drawables)for(const t of e.drawables){const e=new _(t.id,this,t.opacity,t.name,t.indices,t.vertices);e.culling=t.culling,e.blendMode=t.blendMode,this.drawables.push(e)}this.matrix=new t.Matrix,this.alpha=1}update(e){this.coreModel.update(),this.motionManager.update(this,e),this.focusController.update(e);for(const e of this.drawables)e.update(this)}destroy(){this.coreModel.release(),this.coreModel=void 0,this.motionManager.destroy(),this.motionManager=void 0,this.focusController=void 0,this.hitTester=void 0,this.motions=void 0,this.expressions=void 0,this.drawables=void 0,this.masks.destroy(),this.masks=void 0,this.textures=void 0}}class S{constructor(e){this.model=e,this.renderTexture=void 0,this.active=this.model.drawables.some(e=>e.parent instanceof v),this.destroy()}destroy(){this.renderTexture&&this.renderTexture.destroy(!0),this.renderTexture=void 0}render(e,i){if(this.active){this.renderTexture||(this.renderTexture=t.RenderTexture.create({width:e.width,height:e.height}));const n=new t.Matrix;n.scale(1,1),e.render(i,this.renderTexture,void 0,n,void 0)}}}class C{constructor(e){this.live2dModel=e,this.idleMotionName="Idle",this.expressionManager=new P,this.motions=[],this.queue=[],this.currentPriority=0,this.idling=!1}startMotion(e,t,i=3){return"string"==typeof e&&(e=this.live2dModel.motions[e]),e?(e.priority>this.currentPriority&&this.interrupt(),this.currentPriority=e.priority,this.idling=!1,e.isLooping&&this.motions.push(e),this.emit("motionStart",e,t,i),!0):!1}startExpression(e){return"string"==typeof e&&(e=this.live2dModel.expressions[e]),e?(this.expressionManager.setExpression(e),!0):!1}update(e,t){var i,n;if(null===(i=this.expressionManager)||void 0===i||i.update(e,t),this.motions.length>0){let i=!0;for(const n of this.motions)i=i&&!n.update(e,t);i&&this.motions.splice(0)}this.idling||0!==this.motions.length||(this.idling=!0,this.startMotion(this.idleMotionName,void 0,1)),null===(n=e.masks)||void 0===n||n.render(e.textures[0],e.drawables)}interrupt(){for(const e of this.motions)e instanceof d&&e.setFinished(this),this.emit("motionFinish",e,this);this.motions.splice(0),this.currentPriority=0}destroy(){super.destroy(),this.queue=void 0,this.motions=void 0,this.expressionManager=void 0}}t.utils.EventEmitter.mixin(C.prototype);class b{constructor(e){this.live2dModel=e,this.x=0,this.y=0}focus(e,t){this.x=e,this.y=t}update(e){const{x:t,y:i}=this.getCanvasPosition(),n=t-this.x,o=i-this.y;this.drag(n,o);const r=Math.sqrt(nn+oo);this.live2dModel.getParamFloat("ParamAngleX"),this.live2dModel.getParamFloat("ParamAngleY"),this.live2dModel.getParamFloat("ParamBodyAngleX");this.live2dModel.setParamFloat("ParamAngleX",this.live2dModel.getParamFloat("ParamAngleX")+30n),this.live2dModel.setParamFloat("ParamAngleY",this.live2dModel.getParamFloat("ParamAngleY")+30o),this.live2dModel.setParamFloat("ParamBodyAngleX",this.live2dModel.getParamFloat("ParamBodyAngleX")+10n),this.live2dModel.setParamFloat("ParamEyeBallX",n),this.live2dModel.setParamFloat("ParamEyeBallY",o)}getCanvasPosition(){const e=this.live2dModel;return{x:(e.width-1)/2,y:(e.height-1)/2}}drag(e,t){this.live2dModel.getParamFloat("ParamDragX"),this.live2dModel.getParamFloat("ParamDragY");this.live2dModel.setParamFloat("ParamDragX",e),this.live2dModel.setParamFloat("ParamDragY",t)}}class I{constructor(e){this.live2dModel=e,this.hitAreas={}}hitTest(e,t){const i=[];for(const n in this.hitAreas)this.hitAreas.hasOwnProperty(n)&&this.isHit(n,e,t)&&i.push(n);return i}isHit(e,t,i){const{x:n,y:o}=this.hitAreas[e],r=this.live2dModel,s=r.drawables[o],a=r.getParamFloat(n);if(1===a){const e=s.indices,n=s.vertices;let o=-1,r=0;for(let s=0;s<e.length;s+=3){let a=n[2e[s]],c=n[2e[s]+1],l=n[2e[s+1]],h=n[2e[s+1]+1],d=n[2e[s+2]],u=n[2e[s+2]+1];(h-c)(d-l)-(l-a)(u-h)>=0&&((c-i)(h-c)-(a-t)(h-i)>0?o=-o:0,(h-i)(u-h)-(l-t)(u-i)>0?o=-o:0,(u-i)(c-u)-(d-t)(c-i)>0&&(o=-o)),-1===o&&(r=1-r)}if(r)return!0}return!1}}class P{constructor(){this.expressions=[],this.currentPriority=0}setExpression(e){e.priority>this.currentPriority&&(this.expressions.length>0&&(this.expressions[this.expressions.length-1].setFinished(!0),this.expressions.splice(0)),this.expressions.push(e))}update(e,t){for(const i in this.expressions)this.expressions.hasOwnProperty(i)&&!this.expressions[i].update(e,t)&&this.expressions.splice(0,1)}}const D=Object.freeze({proto:null,LOGICAL_WIDTH:1,LOGICAL_HEIGHT:1,fromYukari:function(e){const t=new FileReaderSync;return JSON.parse(t.readAsText(new Blob([e])))}});class A{constructor(){this.xhr=new XMLHttpRequest,this.onProgress=this.onProgress.bind(this)}load(e,t,i){return new Promise(n=>{this.xhr.open("GET",e),this.xhr.responseType=t,this.xhr.onload=()=>n(this.xhr.response),this.onProgress&&(this.xhr.onprogress=i),this.xhr.send()})}onProgress(e){this.onProgress&&this.onProgress(e.target,e.loaded,e.total)}}class L{constructor(){this.loader=new A,this.cache=new Map}load(e,i){var o;const r=i(e,this.loader);return n(this,void 0,void 0,function(){const e=yield r;return null===(o=this.cache)||void 0===o||o.set(i,e),e})}release(e){var t;null===(t=this.cache)||void 0===t||t.delete(e)}}const F={Yukari:"yukari",Moc:"moc",Motion:"motion",Expression:"expression",Physics:"physics",Pose:"pose",DisplayInfo:"cdi",Texture:"texture"};class N{constructor(e={}){this.listeners={},this.loader=new L,this.source=void 0,this.settings=void 0,this.moc=void 0,this.textures=[],this.name=void 0,this.motions=void 0,this.expressions=void 0,this.physics=void 0,this.pose=void 0,this.displayInfo=void 0,this.loadingState={},this.xhr=new A,this.cache=new Map,this.defaultMotionGroup="Idle",this.motionGroups={},this.expressionList=[],this.on("settingsJSONLoaded",(e,t)=>this.onSettingsJSONLoaded(e,t)),this.on("textureLoaded",(e,t)=>this.onTextureLoaded(e,t)),this.on("mocLoaded",e=>this.onMocLoaded(e)),this.on("physicsJSONLoaded",e=>this.onPhysicsJSONLoaded(e)),this.on("poseJSONLoaded",e=>this.onPoseJSONLoaded(e)),this.on("displayInfoJSONLoaded",e=>this.onDisplayInfoJSONLoaded(e)),this.on("motionLoaded",(e,t)=>this.onMotionLoaded(e,t)),this.on("expressionLoaded",e=>this.onExpressionLoaded(e))}load(e){return n(this,void 0,void 0,function*(){this.source=e,this.name=this.source.path.split("/").pop().replace(/..+$/,"");const t=this.source.path;yield this.loader.load(t,L.JSON);this.startLoading();const i=Object.keys(this.loadingState).map(e=>this.loadingState[e]);yield Promise.all(i);const n=this.createInternalModel();return{settings:this.settings,moc:this.moc,textures:this.textures,internalModel:n,animator:new U,unmanaged:!this.source.managed,name:this.name}})}on(e,t){this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t)}emit(e,...t){this.listeners[e]&&this.listeners[e].forEach(i=>i.call(this,e,...t))}startLoading(){const e=this.loader.cache.get(L.JSON);this.settings=e,this.loadTextures(e.textures),this.loadMoc(e.moc),this.loadExpressions(e.expressions),this.loadMotions(e.motions),this.loadPhysics(e.physics),this.loadPose(e.pose),this.loadDisplayInfo(e.displayInfo)}onSettingsJSONLoaded(e,t){var i,n;this.settings=t,this.emit("settingsLoaded",t),this.loadTextures(null===(i=t.textures)||void 0===i?void 0:i.map(e=>this.getURL(e))),this.loadMoc(this.getURL(t.moc)),this.loadExpressions(t.expressions),this.loadMotions(t.motions),this.loadPhysics(this.getURL(t.physics)),this.loadPose(this.getURL(t.pose)),this.loadDisplayInfo(this.getURL(t.cdi)),null===(n=t.groups)||void 0===n||n.forEach(e=>this.registerMotionGroup(e.Name,e.Target,e.Ids))}loadTextures(e){const i=e.map((e,i)=>{this.loadingState["texture"+i]=this.loader.load(e,L.texture);const n=this.loader.cache.get(L.texture);return this.textures[i]=n,this.emit("textureLoaded",i,n),this.loadingState["texture"+i]});return Promise.all(i)}onTextureLoaded(e,i){this.textures[e]=i.texture,this.emit("texture"+e+"Loaded",i)}loadMoc(e){this.loadingState.moc=this.loader.load(e,L.moc),this.emit("mocLoaded",this.loader.cache.get(L.moc))}onMocLoaded(e){this.moc=e,this.emit("mocReady",e)}loadExpressions(e){const t=e.map((e,t)=>{this.loadingState["expression"+t]=this.loader.load(this.getURL(e.file),L.JSON);const i=this.loader.cache.get(L.JSON);return i.name=e.name,this.emit("expressionLoaded",i),this.loadingState["expression"+t]});return Promise.all(t)}onExpressionLoaded(e){this.expressionList.push(e)}loadMotions(e){let t=0;for(const i in e){const n=e[i];this.motionGroups[i]||(this.motionGroups[i]=[]),n.forEach(e=>{this.loadingState["motion"+t]=this.loader.load(this.getURL(e.file),L.motion);const n=this.loader.cache.get(L.motion);this.emit("motionLoaded",i,n),t++})}return Promise.all(Object.values(this.loadingState))}onMotionLoaded(e,t){this.motionGroups[e].push(t)}loadPhysics(e){this.loadingState.physics=this.loader.load(e,L.JSON),this.emit("physicsJSONLoaded",this.loader.cache.get(L.JSON))}onPhysicsJSONLoaded(e){this.physics=e,this.emit("physicsReady",e)}loadPose(e){this.loadingState.pose=this.loader.load(e,L.JSON),this.emit("poseJSONLoaded",this.loader.cache.get(L.JSON))}onPoseJSONLoaded(e){this.pose=e,this.emit("poseReady",e)}loadDisplayInfo(e){this.loadingState.displayInfo=this.loader.load(e,L.JSON),this.emit("displayInfoJSONLoaded",this.loader.cache.get(L.JSON))}onDisplayInfoJSONLoaded(e){this.displayInfo=e,this.emit("displayInfoReady",e)}getURL(e){return this.source.path.replace(/[^/]+$/,"")+e}createInternalModel(){const e=this.settings,t=this.moc,i={motions:this.motionGroups,expressions:this.expressionList,name:this.name,width:e.width,height:e.height,moc:t,textures:this.textures};return new y(i)}release(){this.loader.release(L.JSON),this.loader.release(L.moc),this.loader.release(L.texture),this.loader=void 0}}class U{constructor(){}update(e,t){}}Object.assign(e,{InternalModel:y,Live2DModel:h,Live2DModelSettings:s,Live2DMotion:d,Live2DExpression:u,XHRLoader:A,Yukari:D,config:{LOGICAL_WIDTH:1,LOGICAL_HEIGHT:1},utils:{l,applyMixins:function(e,t){t.forEach(t=>{Object.getOwnPropertyNames(t.prototype).forEach(i=>{Object.defineProperty(e.prototype,i,Object.getOwnPropertyDescriptor(t.prototype,i))})})}}}),Object.defineProperty(e,"__esModule",{value:!0})});
